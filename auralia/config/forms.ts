...
export function getActiveForm(
  ...
  if (
    FORM_CONDITIONS.celestial.check(energy, health, curiosity, bond, dreamCount)
  )
    return "celestial";
  if (
    FORM_CONDITIONS.wild.check(
      energy,
      health,
      curiosity,
      bond,
    ...
    return "wild";
  if (FORM_CONDITIONS.vigilant.check(energy, health, curiosity))
    return "vigilant";
  if (FORM_CONDITIONS.sage.check(energy, health, curiosity, bond))
    return "sage";

...
export function SubAtomicParticleField({
  ...
  const particles = useMemo<Particle[]>(() => {
    ...
    let baseCount =
      consciousParticleCount ??
      Math.max(12, Math.round(10 + (energy ?? 50) / 3));
    ...
    energy,
    consciousParticleCount,
    consciousParticleSpeed,
    consciousParticleSize,
    consciousColorIntensity,
    flowPattern,
    size,
    isLowEndDevice,
  ]);
        ...
        <g
          ...
          style={{
            ...
            animation: reduceMotion
              ? "none"
              : `particle-orbit ${particle.duration}s linear infinite`,
        ...
        >
          <circle
            ...
            style={{
              animation: reduceMotion
                ? "none"
                : `particle-twinkle ${particle.twinkle}s ease-in-out infinite`,

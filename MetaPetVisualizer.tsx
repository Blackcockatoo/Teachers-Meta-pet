          ...
          <div className="bg-gray-800/50 rounded-xl p-6 backdrop-blur">
            ...
            <div className="mt-4 text-center">
              <h2
                ...
                style={{ color: currentForm.accentColor }}
              >
                {currentForm.name}
              </h2>
  ...
  return (
    ...
    >
      <div className="flex items-center justify-between">
        ...
        {!active && isPrimed && (
          <span className="text-cyan-300 text-xs">⚡ READY</span>
        )}
      </div>
    ...
    return (
      <g opacity={baseOpacity}>
        ...
        <circle
          ...
          cy={150}
          r={80}
          stroke={`${colors.secondaryAccent}33`}
          strokeWidth={1}
          fill="none"
        >
          <animateTransform
          ...
          <g key={angle} transform={`rotate(${angle} 150 150)`}>
            ...
            >
              <animate
                ...
                values="0;10"
                dur={`${(9 / curiosityFactor).toFixed(1)}s`}
                repeatCount="indefinite"
              />
            </path>
          </g>
    ...
    return (
      <g opacity={0.4 + black60 / 500}>
        ...
        <ellipse
          ...
          rx={38}
          ry={18}
          fill={`${colors.secondaryAccent}20`}
        >
          <animate
            attributeName="cx"
            values="210;200;210"
            dur={`${(10 / energyFactor).toFixed(1)}s`}
            repeatCount="indefinite"
          />
          <animate
            attributeName="opacity"
        ...
        >
          <animate
            attributeName="stroke-dashoffset"
            values="0;30"
            dur={`${(20 / energyFactor).toFixed(1)}s`}
            repeatCount="indefinite"
          />
        </path>
      </g>
      ...
      <g opacity={0.36 + blue60 / 300}>
        ...
        >
          <animate
            attributeName="stroke-dashoffset"
            values="0;24"
            dur={`${(12 / curiosityFactor).toFixed(1)}s`}
            repeatCount="indefinite"
          />
        </rect>
        {[0, 1, 2].map((index) => (
          ...
          >
            <animate
              attributeName="opacity"
              values="0.3;0.7;0.3"
              dur={`${(8 + (index * 2) / curiosityFactor).toFixed(1)}s`}
              repeatCount="indefinite"
            />
            {["∑", "ψ", "λ"][index]}
          </text>
          ...
          {[0, 40, 80].map((offset) => (
            ...
            >
              <animate
                attributeName="stroke-dashoffset"
                values="0;30"
                dur={`${(15 / curiosityFactor).toFixed(1)}s`}
                repeatCount="indefinite"
              />
            </line>
          ))}
      ...
      <g opacity={0.45 + energy / 220}>
        ...
        >
          <animate
            attributeName="stroke-dashoffset"
            values="0;80"
            dur={`${(7 / energyFactor).toFixed(1)}s`}
            repeatCount="indefinite"
          />
        </path>
        {[120, 180].map((x, index) => (
          <polyline
            ...
            stroke={
              index % 2 === 0
                ? `${colors.secondaryAccent}AA`
                : `${colors.accentColor}AA`
            }
            strokeWidth={2.2}
            fill="none"
            filter="url(#glow)"
          >
            ...
            <animate
              attributeName="opacity"
              values="0.5;1;0.5"
              dur={`${(5 / energyFactor).toFixed(1)}s`}
              repeatCount="indefinite"
            />
          </polyline>
        ))}
        ...
        >
          <animateTransform
            ...
            from="0 150 150"
            to="-360 150 150"
            dur={`${(6 / energyFactor).toFixed(1)}s`}
            repeatCount="indefinite"
          />
        </circle>
      </g>
    ...
    <svg viewBox="0 0 300 300" className="w-full h-full max-w-md">
      <defs>
        ...
        <linearGradient id="red60Grad" x1="0%" y1="0%" x2="0%" y2="100%">
          <stop
            offset="0%"
            style={{ stopColor: "#FF4757", stopOpacity: red60 / 100 }}
          />
          <stop
            offset="100%"
            style={{ stopColor: "#FF4757", stopOpacity: 0 }}
          />
        </linearGradient>
        ...
        <radialGradient id="blue60Grad">
          <stop
            offset="0%"
            style={{ stopColor: "#5F9FFF", stopOpacity: blue60 / 100 }}
          />
          <stop
            offset="100%"
            style={{ stopColor: "#5F9FFF", stopOpacity: 0 }}
          />
        </radialGradient>
      </defs>
      ...
      <g className={isAsleep ? "animate-pulse" : ""}>
          ...
          <>
            ...
            >
              <animate
                attributeName="stroke-dashoffset"
                values="0;30"
                dur={`${Math.max(3.8, 11 - blue60 / 12).toFixed(1)}s`}
                repeatCount="indefinite"
              />
            </ellipse>
            <circle
            ...
            >
              <animate
                attributeName="r"
                values={`${isStudy ? 9 : 7};${isStudy ? 12 : 9};${isStudy ? 9 : 7}`}
                dur={`${Math.max(3, 9 - blue60 / 18).toFixed(1)}s`}
                repeatCount="indefinite"
              />
            </circle>
          </>
        ...
        {!isAsleep && (
          <>
            ...
            <path
              d="M 130 100 L 140 95"
              stroke={colors.accentColor}
              strokeWidth={1}
              opacity={blue60 / 150}
            />
            <path
              d="M 170 100 L 160 95"
              stroke={colors.accentColor}
              strokeWidth={1}
              opacity={blue60 / 150}
            />
          ...
          <>
            ...
            >
              <animateTransform
                ...
                values={
                  isBattle
                    ? "-30 115 80;-25 115 80;-30 115 80"
                    : "-20 120 85;-15 120 85;-20 120 85"
                }
                dur="4s"
                repeatCount="indefinite"
              />
            ...
            >
              <animateTransform
                ...
                values={
                  isBattle
                    ? "30 185 80;25 185 80;30 185 80"
                    : "20 180 85;15 180 85;20 180 85"
                }
                dur="4s"
                repeatCount="indefinite"
              />
        ...
        {!isAsleep ? (
          ...
          <>
            <path
              d="M 130 160 Q 135 165 140 160"
              stroke={colors.accentColor}
              strokeWidth={2}
              fill="none"
            />
            <path
              d="M 160 160 Q 165 165 170 160"
              stroke={colors.accentColor}
              strokeWidth={2}
              fill="none"
            />
        ...
        {isStudy && (
          <g>
            <path
              d="M 150 135 L 145 145 L 150 148 L 155 145 Z"
              fill={colors.accentColor}
              opacity={0.7}
            >
              <animate
...
const Tail = ({
  ...
  if (splits === 2) {
    return (
      <g>
        <path
          d="M 150 190 Q 150 210 150 230"
          stroke={color}
          strokeWidth={6}
          fill="none"
        />
        <path
          d="M 150 230 Q 140 240 135 255"
          stroke={color}
          strokeWidth={4}
          fill="none"
          filter="url(#glow)"
